...
return (
    <div style={{display: 'flex', justifyContent: 'center', alignItems: 'center', height: '100vh',}}>
      <div style={{padding: '15px', borderRadius: '10px', width: '100%', border: '1px solid #ccc', backgroundColor: 'rgb(107, 74, 74)'}}>
        <h2 style={{color:'#535bf2'}}>Sign-in</h2>
        <form action="" onSubmit={handleSubmit}>
            <div style={{marginBottom: '15px'}}>
                <label htmlFor="email" style={{color:'#535bf2'}}><strong>Email</strong></label>
            ...
            <div>
                <label htmlFor="password" style={{color:'#535bf2'}}><strong>Password</strong></label>
                <input type="password" 
